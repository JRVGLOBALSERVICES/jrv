...
function ProceduralCar() {
  ...
  return (
    <group>
      ...
      {[[0.85, 0.15, 0.9], [-0.85, 0.15, 0.9], [0.85, 0.15, -0.9], [-0.85, 0.15, -0.9]].map((pos, i) => (
    ...
    <>
      ...
      <group ref={mesh}>
        <Float speed={1.5} rotationIntensity={0.1} floatIntensity={0.3}>
          {scene ? <X50Model scene={scene} /> : <ProceduralCar />}
        </Float>
      </group>
